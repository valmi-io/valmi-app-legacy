...
function Strategy (options, verify) {
  ...
  this.name = 'slack'
  this._userProfileURL = options.userProfileURL || 'https://slack.com/api/users.profile.get'
  ...
  this._oauth2.getOAuthAccessToken = function (code, params, callback) {
    _oauth2GetOAuthAccessToken.call(self._oauth2, code, params, function (err, accessToken, refreshToken, results) {
